...
class PeriodTest < Test::Unit::TestCase
  ...
  OFF_GRID_TIMES = {
    "1sec"    => ["2011-02-03 04:05:06", "2011-02-03 04:05:06"],
  ...
  snap_tests("off_grid", "2011-02-03 04:05:06", OFF_GRID_TIMES)

  ON_GRID_TIMES = {
    "1sec"    => ["2010-01-01 00:00:00", "2010-01-01 00:00:00"],
    "1min"    => ["2010-01-01 00:00:00", "2010-01-01 00:00:00"],
    "1hr"     => ["2010-01-01 00:00:00", "2010-01-01 00:00:00"],
    "15sec"   => ["2010-01-01 00:00:00", "2010-01-01 00:00:00"],
    "15min"   => ["2010-01-01 00:00:00", "2010-01-01 00:00:00"],
    "15hr"    => ["2010-01-01 00:00:00", "2010-01-01 00:00:00"]
  }
  snap_tests("on_grid", "2010-01-01 00:00:00", ON_GRID_TIMES)
end
